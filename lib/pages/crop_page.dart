...
class _CropPageState extends State<CropPage> {
  ...
  final List<Map<String, String>> scans = [
  {
    ...
    'title': 'TOMATO PLANT',
    'tip':
        'Analyze leaves for blight, leaf spot, or yellow leaf curl virus.',
  },
  {
    'plant': 'Maize',
    ...
    'title': 'MAIZE CORN',
    'tip':
        'Learn to identify common maize diseases such as leaf blight and rust.',
  },
  {
    'plant': 'Potato',
    ...
    'title': 'POTATO LEAF',
    'tip':
        'Check potato leaves for early blight, late blight, and other symptoms.',
  },
  {
    'plant': 'Banana',
    ...
    'title': 'BANANA TREE',
    'tip':
        'Identify common banana diseases by checking leaves for spots and discoloration.',
  },
];
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Tap on the disease category to begin your disease scan',
              style: TextStyle(
                color: Colors.grey,
                fontSize: 14,
              ),
